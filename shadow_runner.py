...
GH_REPO  = os.environ["GH_REPO"]   # e.g. "adrianacavallaro/sunspot-bcn"
...
# 2. LOAD DATA
# =========================================================
print("Loading venues.csv from GitHub...")
...
print("Loading buildings.csv from GitHub...")
buildings_raw = requests.get(
    f"https://raw.githubusercontent.com/{GH_REPO}/main/buildings.csv"
).text
buildings_df = pd.read_csv(StringIO(buildings_raw))
